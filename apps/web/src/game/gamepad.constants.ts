...
export const BUTTON_L3 = 10;
export const BUTTON_R3 = 11;
...
export const BUTTON_HOME = 16;

export const AXIS_LEFT_STICK_X = 0;
export const AXIS_LEFT_STICK_Y = 1;
export const AXIS_RIGHT_STICK_X = 2;
export const AXIS_RIGHT_STICK_Y = 3;
export const AXIS_DPAD_X = 6;
export const AXIS_DPAD_Y = 7;
